...
int main()
{
    ...
    for (long long int i = 0; i < m;i++){
        ...
        if(x == 4) l % 2 == 1 ? cout << dp[r][1] - dp[l - 1][1] << endl : cout << dp[r][0] - dp[l - 1][0] << endl;
        if(x == 5) l % 2 == 1 ? cout << dp[r][1] - dp[l - 1][1] << endl : cout << dp[r][0] - dp[l - 1][0] << endl;
        if(x == 6) l % 2 == 1 ? cout << dp[r][1] - dp[l - 1][1] << endl : cout << dp[r][0] - dp[l - 1][0] << endl;
        if(x == 7) l % 2 == 1 ? cout << dp[r][1] - dp[l - 1][1] << endl : cout << dp[r][0] - dp[l - 1][0] << endl;
    }
    return 0;
}